          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {['firstName', 'lastName', 'username', 'email', 'pan', 'aadhar'].map((field) => (
              <div key={field} className="group">
                <label className="block text-sm font-medium text-gray-300 mb-2 capitalize transition-all duration-200 group-focus-within:text-cyan-400">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-gray-700/50 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 transition-all duration-200"
                />
                {errors[field] && <p className="mt-1 text-sm text-cyan-400">{errors[field]}</p>}
              </div>
            ))}

            {/* Password */}
            <div className="group">
              <label className="block text-sm font-medium text-gray-300 mb-2 transition-all duration-200 group-focus-within:text-cyan-400">
                Password
              </label>
              <input
              ...
              <label className="flex items-center gap-2 mt-3 text-sm text-gray-400 hover:text-gray-200 cursor-pointer transition-colors relative ">
                <input
                  ...
                  onChange={handleChange}
                  className="w-4 h-4 accent-cyan-500 hidden"
                />
                {formData.showPassword ?
                  <RiEyeCloseFill className='absolute -top-12 right-4 text-2xl text-cyan-400' /> : <BsEyeFill className='absolute -top-12 right-4 text-2xl text-cyan-400' />
                }
              </label>
              {errors.password && <p className="mt-1 text-sm text-cyan-400">{errors.password}</p>}
            </div>
            ...
            <div className="group">
              ...
              <div className="flex gap-3">
                <select
                  ...
                  onChange={handleChange}
                  className="w-28 px-3 py-3 bg-[#2e3341] text-white border rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500/50 transition-all duration-200 appearance-none"
                >
                ...
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-white/5 border border-gray-700/50 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 transition-all duration-200"
                />
              </div>

              {errors.phoneNumber && <p className="mt-1 text-sm text-cyan-400">{errors.phoneNumber}</p>}
            </div>
            ...
            <div className="group">
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 bg-[#2e3341] border border-gray-700/50 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 transition-all duration-200"
              >
              ...
              {errors.country && <p className="mt-1 text-sm text-cyan-400">{errors.country}</p>}
            </div>
            ...
            <div className="group">
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-[#2e3341] border border-gray-700/50 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 transition-all duration-200 disabled:opacity-50"
              >
              ...
              {errors.city && <p className="mt-1 text-sm text-cyan-400">{errors.city}</p>}
            </div>
